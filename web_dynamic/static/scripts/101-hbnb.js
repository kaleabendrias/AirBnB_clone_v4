window.addEventListener('load', function () {
  ...
  function toggleReviews() {
    const toggleElement = document.getElementById("toggleReviews");
    const reviewsList = document.getElementById("reviewsList");
    const reviewsHeader = document.getElementById("reviewsHeader");

    if (toggleElement.innerText === "show") {
        const reviewsData = fetchReviews(); // Implement the function to fetch the reviews
